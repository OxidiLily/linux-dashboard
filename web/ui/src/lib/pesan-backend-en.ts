...
const kalimatBackend: Record<string, string> = {
  ...
  "alamat IP tidak valid: %s": "invalid IP address: %s",
  "alamat IP tidak valid": "invalid IP address",
  "gateway tidak valid: %s": "invalid gateway: %s",
  "nama interface tidak valid": "invalid interface name",
  "mode IP tidak dikenal": "unknown IP mode",
  "mode statis butuh minimal satu alamat": "manual mode needs at least one address",
  "interface %s tidak dikelola netplan": "interface %s is not managed by netplan",
