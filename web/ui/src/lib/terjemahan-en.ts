...
daftarkanTerjemahan({
  ...
  "Belum ada named volume di host ini.": "No named volumes on this host yet.",
  "Bind mount (mis. /home/user/data:/data di compose) tidak muncul di sini — itu folder host biasa, bukan volume yang dikelola Docker.": "Bind mounts (e.g. /home/user/data:/data in compose) do not show up here \u2014 they are plain host folders, not Docker-managed volumes.",
  ...
  "File .env tersimpan — belum diterapkan.": ".env saved — not applied yet.",
  "Terapkan sekarang?": "Apply it now?",
  "Up sekarang": "Up now",
  "Container yang sedang jalan masih memakai nilai lama — environment dibaca saat container DIBUAT, dan Restart tidak membuatnya ulang. Panel akan menjalankan Up (docker compose up -d), yang membuat ulang hanya container yang konfigurasinya berubah.":
    "The running containers still use the old values — the environment is read when a container is CREATED, and Restart does not recreate it. The panel will run Up (docker compose up -d), which recreates only the containers whose configuration changed.",
  ...
  "Isi divalidasi Docker dulu; kalau ditolak, file lama tidak disentuh. Versi lama disimpan sebagai .bak. Menyimpan TIDAK men-deploy — panel menawarkan Up sesudahnya, dan Restart saja tidak cukup.": "The content is validated by Docker first; if it is rejected the old file is untouched. The previous version is kept as .bak. Saving does NOT deploy — the panel offers Up afterwards, and a Restart alone is not enough.",
  ...
  "docker-compose.yml tersimpan — belum diterapkan.": "docker-compose.yml saved — not applied yet.",
  "Isi lama tertimpa seluruhnya. Nilai baru belum berlaku sampai container DIBUAT ULANG — Restart tidak cukup. Panel menawarkan Up sesudah tersimpan.": "The old content is overwritten entirely. The new values do not take effect until the containers are RECREATED — a Restart is not enough. The panel offers Up once it is saved.",
  ...
  "Memasang {0} — prosesnya berlanjut walau halaman ditinggal": "Installing {0} — it keeps running if you leave this page",
  "Memproses {0} — prosesnya berlanjut walau halaman ditinggal": "Working on {0} — it keeps running if you leave this page",
  "Aksi pada {0} selesai.": "The action on {0} has finished.",
  ...
  "menyiapkan penghapusan": "preparing the removal",
  ...
  // ---- pesan aksi berjalan (notify.tugas) + sisa kalimat printer ----
  "Memasang komponen {0}…": "Installing component {0}…",
  "Menghapus komponen {0}…": "Removing component {0}…",
  "Service {0}: {1}…": "Service {0}: {1}…",
  "Service {0}: {1} berhasil.": "Service {0}: {1} succeeded.",
  "Memasang driver {0}…": "Installing the {0} driver…",
  "Menambah printer {0}…": "Adding printer {0}…",
  "Menghapus printer {0}…": "Removing printer {0}…",
  "Menjadikan {0} printer default…": "Making {0} the default printer…",
  "{0} jadi printer default": "{0} is now the default printer",
  "Mematikan antrean {0}…": "Disabling queue {0}…",
  "Menyalakan antrean {0}…": "Enabling queue {0}…",
  "Antrean {0} dimatikan": "Queue {0} disabled",
  ...
  "Mematikan ufw…": "Disabling ufw…",
  "ufw dinyalakan.": "ufw enabled.",
  "ufw dimatikan.": "ufw disabled.",
  "Menyimpan rule firewall…": "Saving the firewall rule…",
  "Menambah rule firewall…": "Adding a firewall rule…",
  "Rule firewall ditambahkan.": "Firewall rule added.",
  "Menghapus rule firewall…": "Removing the firewall rule…",
  "Rule firewall dihapus.": "Firewall rule removed.",
  "Menyimpan jail {0}…": "Saving jail {0}…",
  "Membuat jail {0}…": "Creating jail {0}…",
  "Mengaktifkan jail {0}…": "Enabling jail {0}…",
  "Mematikan jail {0}…": "Disabling jail {0}…",
  "Menghapus jail {0}…": "Removing jail {0}…",
  "Jail {0} dihapus.": "Jail {0} removed.",
  "Melepas blokir {0}…": "Unbanning {0}…",
  "Menyimpan share {0}…": "Saving share {0}…",
  "Membuat share {0}…": "Creating share {0}…",
  "Menghapus share {0}…": "Removing share {0}…",
  "Share {0} dihapus.": "Share {0} removed.",
  "Menambah user Samba {0}…": "Adding Samba user {0}…",
  "Menyimpan password Samba {0}…": "Saving the Samba password for {0}…",
  "Mematikan user Samba {0}…": "Disabling Samba user {0}…",
  "Mengaktifkan user Samba {0}…": "Enabling Samba user {0}…",
  "User Samba {0} dimatikan.": "Samba user {0} disabled.",
  "User Samba {0} diaktifkan.": "Samba user {0} enabled.",
  "Menghapus user Samba {0}…": "Removing Samba user {0}…",
  "User Samba {0} dihapus.": "Samba user {0} removed.",
  "Menyimpan export {0}…": "Saving export {0}…",
  "Membuat export {0}…": "Creating export {0}…",
  "Menghapus export {0}…": "Removing export {0}…",
  "Export {0} dihapus.": "Export {0} removed.",
  "Menyimpan pool {0}…": "Saving pool {0}…",
  "Membuat pool {0}…": "Creating pool {0}…",
  "Melepas pool {0}…": "Unmounting pool {0}…",
  "Memasang pool {0}…": "Mounting pool {0}…",
  "Menghapus pool {0}…": "Removing pool {0}…",
  "Pool {0} dihapus.": "Pool {0} removed.",
  "Membuat folder {0}…": "Creating folder {0}…",
  "Folder {0} dibuat.": "Folder {0} created.",
  "Menyimpan file…": "Saving the file…",
  "Menghapus {0}…": "Removing {0}…",
  "Mengubah permission {0}…": "Changing permissions on {0}…",
  "Permission {0} jadi {1}.": "Permissions on {0} set to {1}.",
  "Mengganti nama {0}…": "Renaming {0}…",
  "{0} diganti nama jadi {1}.": "{0} renamed to {1}.",
  "Menyalin {0} item…": "Copying {0} items…",
  "Memindahkan {0} item…": "Moving {0} items…",
  "{0} item disalin.": "{0} items copied.",
  "{0} item dipindahkan.": "{0} items moved.",
  "Menghapus {0} item…": "Removing {0} items…",
  "Mengirim {0} ke printer…": "Sending {0} to the printer…",
  "Memformat {0} lalu memasangnya di {1}…": "Formatting {0} and mounting it at {1}…",
  "Memasang {0} di {1}…": "Mounting {0} at {1}…",
  ...
  "Mengubah password…": "Changing the password…",
  "Mengubah hostname jadi {0}…": "Changing the hostname to {0}…",
  "Membuat user {0}…": "Creating user {0}…",
  "Menghapus user {0}…": "Removing user {0}…",
  "User {0} dihapus.": "User {0} removed.",
  "Mereset password {0}…": "Resetting the password for {0}…",
  "Menyimpan perubahan user {0}…": "Saving changes to user {0}…",
  "User {0} diperbarui.": "User {0} updated.",
  "Menutup sesi terminal…": "Closing terminal sessions…",
  "Menghentikan PID {0}…": "Stopping PID {0}…",
  "PID {0} dihentikan.": "PID {0} stopped.",
  "Menyimpan docker-compose.yml…": "Saving docker-compose.yml…",
  "Menyimpan file .env…": "Saving the .env file…",
  "Gagal memuat printer: {0}": "Failed to load printers: {0}",
  "Gagal memindai printer: {0}": "Failed to scan for printers: {0}",
  "Gagal mendeteksi printer: {0}": "Failed to detect printers: {0}",
  "Gagal memasang driver: {0}": "Failed to install the driver: {0}",
  "Gagal menambah printer: {0}": "Failed to add the printer: {0}",
  "Gagal menghapus printer: {0}": "Failed to remove the printer: {0}",
  "Gagal set default: {0}": "Failed to set the default printer: {0}",
  "Gagal mengubah status antrean: {0}": "Failed to change the queue state: {0}",
  "Gagal membatalkan cetakan: {0}": "Failed to cancel the print job: {0}",
  "Printer {0} ditambahkan": "Printer {0} added",
  "Printer {0} dihapus": "Printer {0} removed",
  "Cetakan {0} dibatalkan": "Print job {0} cancelled",
  "Hapus printer {0}?": "Remove printer {0}?",
  "Hapus printer {0}": "Remove printer {0}",
  "Matikan antrean {0}": "Disable queue {0}",
  "Nyalakan antrean {0}": "Enable queue {0}",
  "Gagal memuat daftar printer: {0}": "Failed to load the printer list: {0}",
  "Gagal mencetak: {0}": "Failed to print: {0}",
  ...
  // Pencarian sampai ke dalam subfolder dijalankan lewat Enter atau tombol
  // Cari, jadi tempatnya menyebut keduanya sekaligus.
  "Cari berkas di folder ini dan subfoldernya…": "Search this folder and its subfolders…",
  "Mencari…": "Searching…",
  ...
  "di sini": "here",
  "Tidak ada berkas atau folder yang memuat \"{0}\" sampai ke subfolder.":
    "No file or folder contains \"{0}\" down to the subfolders.",
